...
async function listarDisponibilidades(estudianteId) {
...
async function crearDisponibilidad(estudianteId, payload) {
  const response = await fetch(`${API_BASE_URL}/disponibilidades`, {
    method: "POST",
...
async function actualizarDisponibilidad(id, estudianteId, payload) {
...
async function eliminarDisponibilidad(id, estudianteId) {
  const response = await fetch(`${API_BASE_URL}/disponibilidades/${id}`, {
    method: "DELETE",
  });
...
async function listarCiclos(estudianteId) {
...
/* ==========================================================================
   COMPONENTE PRINCIPAL: GESTION DISPONIBILIDAD
   ========================================================================== */
